    ...
    const cards = [
      ...
      const checkedItemHandler = (value, isChecked) => {
        if (isChecked) {
          ...
          setPostHandler(checkedItems);
        } else if (!isChecked && checkedItems.find(sortType => sortType === value)) {
      ...
      <div className='nft_card_info' style={{backgroundImage: `url("${card.url}")`}}>
      ...
      <div className='main_container'>
        ...
        <div className='main_filter_section'>
          ...
          <div className='race_section'>
            ...
            <input id="ch_beny" className='beny_checkbox' type='checkbox' value='b' onChange={(e) => checkHandler(e)}/>
            <label for='ch_beny'>
            ...
            <input id="ch_arche" className='arche_chekbox' type='checkbox' value='a' onChange={(e) => checkHandler(e)} />
            <label for='ch_arche'>
            ...
            <input id="ch_luchia" className='luchia_chekbox' type='checkbox' value='l' onChange={(e) => checkHandler(e)}/>
            <label for='ch_luchia'>
          ...
          <div className='rarity_section'>
            ...
            <div className='rarity_filter_section'>
              <input id='ch_epic' className='epic_checkbox' type='checkbox' value='e' onChange={(e) => checkHandler(e)}/>
              <label for='ch_epic'>
              ...
              <input id='ch_sr' className='sr_checkbox' type='checkbox' value='sr' onChange={(e) => checkHandler(e)}/>
              <label for='ch_sr'>
              ...
              <input id='ch_r' className='r_checkbox' type='checkbox' value='r' onChange={(e) => checkHandler(e)}/>
              <label for='ch_r'>
              ...
              <input id='ch_n' className='n_checkbox' type='checkbox' value='n' onChange={(e) => checkHandler(e)}/>
              <label for='ch_n'>
