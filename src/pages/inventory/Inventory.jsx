    ...
    <div className='inventory_container'>
        ...
        <div className='my_nft_container'>
            <div className='my_nft_list_section'>
                <input id="ch_my_nft" className='my_nft_checkbox' name="inventory" type='radio' value='my_nft' onChange={(e) => checkHandler(e)}/>
                <label for='ch_my_nft'>
                ...
                <input id="ch_activity" className='activity_checkbox' name="inventory" type='radio' value='ch_activity' onChange={(e) => checkHandler(e)}/>
